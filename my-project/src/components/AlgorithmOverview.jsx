    ...
    <div className="flex flex-col md:flex-row gap-6">
      <ContentCard>
        <div className="flex items-center mb-4">
          <FaLock className="text-indigo-600 text-2xl mr-2" />
          <h3 className="font-semibold text-xl">AES (Advanced Encryption Standard)</h3>
        </div>
      ...
      <ContentCard>
        <div className="flex items-center mb-4">
          <FaKey className="text-purple-600 text-2xl mr-2" />
          <h3 className="font-semibold text-xl">RSA (Rivest-Shamir-Adleman)</h3>
        </div>
